...
Tap no card DAKI50
     Wait Until Element Is Visible    ${CARD_DAKI50} 
    Click Element                     ${CARD_DAKI50}  
Confirma se o texto "${TEXTO_CUPOM}" esta tela 
    Wait Until Page Contains          ${TEXTO_CUPOM}
